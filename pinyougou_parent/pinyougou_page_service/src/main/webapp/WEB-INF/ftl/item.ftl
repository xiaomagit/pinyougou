                        ...
                        <#list specificationList as specification>
                            <dl>
                                ...
                                <#list specification.attributeValue as item>
                                    <dd><a class="{{isSelected('${specification.attributeName}','${item}')?'selected':''}}" href="javascript:;" ng-click="selectSpecification('${specification.attributeName}','${item}')">${item}<span title="点击取消选择">&nbsp;</span></a></dd>
                                </#list>
                            </dl>
                        </#list>
